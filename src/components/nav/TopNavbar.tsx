    ...
    <div className="w-full h-full flex items-center justify-between px-4 lg:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
          ...
          {openDropdown === 'notifications' && (
            <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 z-50 overflow-hidden animate-fade-in-down">
              <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-900/50">
                ...
                <button className="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium">Mark all as read</button>
              </div>
              <div className="max-h-72 overflow-y-auto">
                {/* Example Notification Items */}
                <a href="#" className="block px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors border-b border-gray-50 dark:border-gray-700/50 last:border-0 relative">
                  <p className="text-sm text-gray-800 dark:text-gray-200"><span className="font-semibold">Emma Watson</span> replied to your comment</p>
                  <p className="text-xs text-gray-500 mt-1">Just now</p>
                  <span className="absolute top-4 right-4 w-2 h-2 bg-blue-500 rounded-full"></span>
                </a>
                <a href="#" className="block px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  <p className="text-sm text-gray-800 dark:text-gray-200"><span className="font-semibold">System</span> Update completed successfully</p>
                  <p className="text-xs text-gray-500 mt-1">2 hours ago</p>
                </a>
              </div>
              <div className="p-2 border-t border-gray-100 dark:border-gray-700 text-center bg-gray-50 dark:bg-gray-900/50">
                <Link to="/app/social/notifications" onClick={closeDropdown} className="text-xs font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400">View All Notifications</Link>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="relative pl-2 ml-2 border-l border-gray-200 dark:border-gray-700" ref={profileRef}>
          ...
          >
            <div className="w-8 h-8 md:w-9 md:h-9 rounded-full overflow-hidden border-2 border-gray-200 dark:border-gray-600 ring-2 ring-transparent hover:ring-blue-100 dark:hover:ring-blue-900 transition-all">
              <img src="/assets/img/team/3-thumb.jpg" alt="User" className="w-full h-full object-cover" />
            </div>
            <div className="hidden md:block text-left">
              <p className="text-xs font-semibold text-gray-700 dark:text-gray-200 leading-tight">Admin User</p>
          ...
          {openDropdown === 'profile' && (
            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 z-50 py-2 animate-fade-in-down">
              <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700 mb-2">
                <p className="text-sm font-semibold text-gray-900 dark:text-white">Sign In as</p>
                <p className="text-sm text-gray-500 truncate">admin@itpc.com</p>
              </div>

              <Link to="/pages/user/profile" onClick={closeDropdown} className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700">Your Profile</Link>
              <Link to="/pages/user/settings" onClick={closeDropdown} className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700">Settings</Link>
